...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.provider_ref'
        db.add_column(u'donations_donation', 'provider_ref',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.provider_ref'
        db.delete_column(u'donations_donation', 'provider_ref')
