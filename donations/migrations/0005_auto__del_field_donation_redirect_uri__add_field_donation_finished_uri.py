...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Donation.finished_uri'
        db.add_column(u'donations_donation', 'finished_uri',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Donation.finished_uri'
        db.delete_column(u'donations_donation', 'finished_uri')
