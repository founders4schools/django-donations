...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'django_donations_donationprovider', 'name',
                      self.gf('django.db.models.fields.CharField')(default='BlankProvider', max_length=100),
                      keep_default=False)

        # Adding field 'DonationProvider.description'
        db.add_column(u'django_donations_donationprovider', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'Donation.user'
        db.delete_column(u'django_donations_donation', 'user_id')

        # Adding field 'Donation.provider'
        db.add_column(u'django_donations_donation', 'provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['django_donations.DonationProvider']),
                      keep_default=False)

        # Adding field 'Donation.donor'
        db.add_column(u'django_donations_donation', 'donor',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'django_donations_donationprovider', 'name')

        # Deleting field 'DonationProvider.description'
        db.delete_column(u'django_donations_donationprovider', 'description')

        # Adding field 'Donation.user'
        db.add_column(u'django_donations_donation', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Donation.provider'
        db.delete_column(u'django_donations_donation', 'provider_id')

        # Deleting field 'Donation.donor'
        db.delete_column(u'django_donations_donation', 'donor_id')
    ...
    models = {
        ...
        u'django_donations.donation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_donations.DonationProvider']"})
        },
